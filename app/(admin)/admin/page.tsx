...
import { profiles, paiements, concoursInscrits } from "@/drizzle/schema";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="font-bold text-slate-800 text-sm">Répartition des Paiements</h3>
          </div>
          <div className="flex items-center justify-center gap-8">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-600 font-medium">Validés</span>
                <span className="font-bold text-slate-800 ml-auto">{validatedPaymentsCount}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-amber-500 flex-shrink-0" />
                <span className="text-slate-600 font-medium">En attente</span>
                <span className="font-bold text-slate-800 ml-auto">{pendingPaymentsCount}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-red-500 flex-shrink-0" />
                <span className="text-slate-600 font-medium">Rejetés</span>
                <span className="font-bold text-slate-800 ml-auto">{rejectedPaymentsCount}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="font-bold text-slate-800 text-sm">Candidats Actifs / Inactifs</h3>
          </div>
          <div className="flex items-center justify-center gap-8">
            <DonutChart
              segments={[
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-slate-800 ml-auto">{activeCandidates}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-slate-400 flex-shrink-0" />
                <span className="text-slate-600 font-medium">Inactifs</span>
                <span className="font-bold text-slate-800 ml-auto">{inactiveCandidates}</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-3 text-sm max-h-[170px] overflow-y-auto pr-1">
                {Object.entries(zoneCounts).map(([zoneName, count]) => (
                  <div key={zoneName} className="flex justify-between items-center py-0.5 border-b border-slate-50">
                    ...
                    <span className="font-bold text-slate-800 bg-slate-100 px-2 py-0.5 rounded-full text-sm">
                      {count}
                    </span>
                  </div>
                ))}
