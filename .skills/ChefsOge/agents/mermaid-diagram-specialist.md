...
- **ChefsOge context** : brief de délégation et cartographie d'impact si mode multi-agents

**Skill attaché (obligatoire) :** charger `banques_skills/skills-globales/skill-mermaidH/SKILL.md` pour tout diagramme — workflow 5 phases, validation, intégration manager.
