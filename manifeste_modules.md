...
* **[documents/page.tsx](file:///c:/Users/Toto.ADMINISTRATOR/Desktop/oge-academie/app/(zone)/zone/documents/page.tsx)**
  * **Description :** Page de listing et d'ajout de documents de cours/TD spécifiques à la zone du manager, incluant également en lecture seule les documents globaux (`zone = "tous"`) publiés par l'Administration Nationale.
...
* **[documents/ZoneDocumentsClient.tsx](file:///c:/Users/Toto.ADMINISTRATOR/Desktop/oge-academie/app/(zone)/zone/documents/ZoneDocumentsClient.tsx)**
  * **Description :** Composant client interactif d'upload (PDF, Liens externes Google Drive avec avertissement de sécurité ou Live Google Meet), de consultation directe de PDF et de gestion des documents pour la zone du manager. Protège les documents globaux en lecture seule avec badge `Admin Nationale`.
